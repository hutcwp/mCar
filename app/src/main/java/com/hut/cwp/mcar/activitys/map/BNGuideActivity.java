...
public class BNGuideActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 必须设置APPID，否则会静音
		bundle1.putString(BNCommonSettingParam.TTS_APP_ID, "8680427");
		BNaviSettingManager.setNaviSdkParam(bundle1);
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(BNMainPresentMain.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
		if (hd != null) {
	...
	protected void onDestroy() {
		...
		BNMainPresentMain.activityList.remove(this);
