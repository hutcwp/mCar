package com.hut.cwp.mcar.zero.view;
...
import com.hut.cwp.mcar.zero.other.OilCityCallback;
...
public class OilCityActivity extends Activity {
    ...
    private static String URL = "http://api.avatardata.cn/OilPrice/LookUp?key=3e4fe1f9e2ff4cbc84339018aebe1061&prov=北京";  //阿凡达平台（免费）  需要直接键入省级区域名
